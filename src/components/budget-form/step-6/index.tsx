  ...
  return (
    <>
      <div className="border border-neutral-200 rounded-xl p-6 bg-white space-y-4 divide-y divide-neutral-200">
        <h1 className="text-base font-bold text-blue-600 flex items-center gap-2 sm:text-lg">
          <ReadCvLogo size={24} />
          RESUMO DO ORÇAMENTO
        </h1>
        ...
        <div className="grid grid-cols-1 gap-4">
          <div className="grid grid-cols-1 sm:grid-cols-3 col-span-2 gap-4 pt-4">
            ...
            <div className="capitalize p-6 flex flex-col gap-2 items-start justify-center cursor-fronty-default rounded-lg bg-white border text-neutral-800">
              ...
              <h2 className="text-sm">{formState.productType}</h2>
            </div>
            ...
            <div className="capitalize p-6 flex flex-col gap-2 items-start justify-center cursor-fronty-default rounded-lg bg-white border text-neutral-800">
              ...
              <h2 className="text-sm">{formState.niche.name}</h2>
            </div>
            ...
            <div className="capitalize p-6 flex flex-col gap-2 items-start justify-center cursor-fronty-default rounded-lg bg-white border text-neutral-800">
              ...
              <h2 className="text-sm">{formState.receipe.label}</h2>
            </div>
                ...
                <>
                  {formState.modelDetails.extra?.color &&
                    formState.modelDetails.extra.model && (
                      <p className="text-sm flex items-start gap-1 capitalize">
            ...
            <div className="bg-neutral-50 border rounded-lg flex justify-center p-4 items-center">
              <img src={formState.modelDetails.preview} className="w-44 sm:w-72" />
            </div>
      ...
      <SuccessModal isOpen={isOpen} onClose={handleCloseModal} />
    </>
  );
}
